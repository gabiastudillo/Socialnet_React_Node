        ...
        return (
            <div className="card mx-2 my-2">
                    ...
                    <div className="card-body p-1 m-0 w-100 d-flex">
                        ...
                        <div className="m-0 p-0 w-100">
                            <div className="form-group m-0 p-0 w-100">
                                <textarea className="form-control w-100 font-weight-normal m-0 pt-3 border-0" rows="3" placeholder="¿Qué estás pensando, Gabriela?"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-footer p-3">
                    <div className="row justify-content-around pt-1 pb-3">
                        <div className="col-4">
                    ...
                    <button type="button" className="btn btn-primary w-100">Publicar</button>
                </div>
            </div>
        )
    }
