                ...
                <div className="card text-white">
                    ...
                    <div className="card-img-overlay">
                        <div className="media h-100">
                            <img src={'https://laboratoriosniam.com/wp-content/uploads/2018/07/michael-dam-258165-unsplash_WEB2.jpg'} width="180" height="180" className="align-self-end rounded-circle mr-2 mt-2 img-rounded thumbnail" alt="" />
