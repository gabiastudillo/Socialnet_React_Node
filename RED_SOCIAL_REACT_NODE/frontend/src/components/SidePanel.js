                ...
                <ul className="navbar-nav flex-column flex w-100 nav-pills px-1">
                    <li className="nav-item active">
                        <Link className="nav-link mt-0 mb-2 border" to="/Perfil">
                            <img src={'https://laboratoriosniam.com/wp-content/uploads/2018/07/michael-dam-258165-unsplash_WEB2.jpg'} width="25" height="25" className="rounded-circle border-0 ml-4 mr-2" alt="" />Gabriela Astudillo
                        </Link>
                    </li>
                    <li className="nav-item active">
                        <Link className="nav-link my-2 border" to="/"><i className="fas fa-newspaper ml-4 mr-4"></i>Noticias</Link>
                    </li>
                    <li className="nav-item active">
                    ...
                    <li className="nav-item active">
                        <Link className="nav-link my-2 border" to="google.com"><i className="fas fa-users ml-4 mr-3"></i>Grupos</Link>                    </li>
